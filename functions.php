...
function replace_jquery() {
  if (!is_admin()) {
    ...
    wp_register_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js', false, '1.12.0');
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
      ...
      wp_enqueue_script('carousel', 'https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.js', false, '1.3.3');
